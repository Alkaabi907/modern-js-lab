...
const both = [...morePizzaToppings,...uncontroversialPizzaToppings];
...
anotherCar.make = "JETOUR"
anotherCar.model = "T2"

console.log('Original:',anotherCar)
console.log('Duplicated:',myCar)
...
function AddTwoPets(Pet,Color){
    return Pet + Color;
}
AddTwoPets("Cat", "Orange")
